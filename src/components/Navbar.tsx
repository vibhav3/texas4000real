...
export default function NavBar({
  ...
  return (
    <nav aria-label="Main navigation">
      <ul className="flex flex-col justify-between rounded-b-lg bg-blue-200 px-4 py-2 md:m-4 md:flex-row md:items-center md:rounded-xl">
        ...
        <div
          className={clsx(
            "fixed bottom-0 left-0 right-0 top-0 z-50 flex flex-col items-end gap-4 bg-blue-200 pr-4 pt-14 transition-transform duration-300 ease-in-out md:hidden",
